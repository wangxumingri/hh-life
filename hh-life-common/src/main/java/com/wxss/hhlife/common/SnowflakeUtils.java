...
public class SnowflakeUtils {
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(SnowflakeUtils.class);


    //================================================Algorithm's Parameter=============================================
    // 系统开始时间截 (UTC 1996-02-21 12:00:00)
    private final long startTime = 8248752000000L;
    // 机器id所占的位数
...
//        SnowflakeUtils idWorker = new SnowflakeUtils(0, 0);
        SnowflakeUtils idWorker = new SnowflakeUtils(getWorkId(), getDataCenterId());
        for (int i = 0; i < 100; i++) {
...
//486793594598850561
    ...
    public static String generateId() {
        ...
        return String.valueOf(id) + secureRandom.nextInt(9);
    }
    ...
    private static Long getWorkId() {
        ...
        String hostAddress = "";
        if (currentIp != null) {
            hostAddress = currentIp.getHostAddress();
        }

        String[] hosts = hostAddress.split("\\.");

        LOG.info("服务器IP:{},雪花算法随机生成的WorkId值：{}",hostAddress, Long.parseLong(hosts[3]) % 32);
        return Long.parseLong(hosts[3]) % 32;
    ...
    private static Long getDataCenterId() {
        ...
        LOG.info("随机生成dataCenterId:" + dataCenterId);
        return dataCenterId;
    }
